...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="fila">
        ...
        <div id="fila_borrar"><a runat="server" href="#"><img src="images/papelera.png" width="30" height="40"></div></a>
    </div>
    <div id="fila">
        <img src="images/caratula.jpg" width="76" height="112" alt="Nombre_Pelicula">
   ...
   <h4>9,00 Euros</h4></a>
    ...
    <div id="botones">
         <a runat="server" href="#" class="boton2">Seguir Comprando</a>
        <a runat="server" href="/Pagar.aspx" class="boton2">Finalizar compra y PAGAR</a>
